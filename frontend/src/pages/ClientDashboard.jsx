    ...
    const init = async () => {
      try {
        ...
        const canvas = new fabric.Canvas(canvasRef.current, {
          ...
          selection: false, interactive: false, renderOnAddRemove: false,
        });
  ...
  return (
    <div style={{ position: "relative", width: "100%" }}>
      ...
      {error ? (
        ...
        <div style={{ width: "100%", overflowX: "auto", overflowY: "auto", border: "1px solid #E2E8F0", borderRadius: 10, background: "#fff", maxHeight: "60vh" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
              ...
              <div style={{ gridColumn: "1/-1" }}>
                ...
                <textarea value={form.description}
                  ...
                  placeholder="Décrivez votre projet..." rows={4}
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th>Statut</th><th style={{ textAlign: "center" }}>Actions</th>
                </tr>
              </thead>
              <tbody>
                      ...
                      <td colSpan={5} style={{ padding: "16px 12px" }}>
                        <form onSubmit={handleEditSubmit}>
                          ...
                          <div style={{ display: "flex", gap: 8 }}>
                            <button type="submit" disabled={sending || !!editErrors.date_début || !!editErrors.date_fin} style={{
